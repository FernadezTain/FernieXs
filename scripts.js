const DURATIONS = {
    "12h": ["12 ч.", 12 * 3600, 750, 100],       // DC +25
    "24h": ["24 ч.", 24 * 3600, 1500, 150],     // DC +25
    "3d":  ["3 дн.", 3 * 86400, 3000, 300],     // DC +25
    "7d":  ["7 дн.", 7 * 86400, 7500, 800],     // DC +50
    "15d": ["15 дн.", 15 * 86400, 20000, 2100], // DC +50
    "30d": ["30 дн.", 30 * 86400, 37500, 4000], // DC +200
    "6m":  ["6 мес.", 6 * 30 * 86400, 200000, 20500], // DC +450
    "1y":  ["1 год", 365 * 86400, 400000, 40500]      // DC +450
};
